            ...
            <div className='flex flex-wrap justify-between sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50' key={index}>
              ...
              <p>{currency}{item.amount}</p>
              {
                ...
                : item.isCompleted 
                  ...
                  : <div className='flex items-center gap-2'>
                      <X onClick={() => cancelAppointment(item._id)} className='w-10 cursor-pointer text-red-500' />
                      <Check onClick={() => completeAppointment(item._id)} className='w-10 cursor-pointer text-green-500' />
                    </div>
              }
            </div>
          ))
